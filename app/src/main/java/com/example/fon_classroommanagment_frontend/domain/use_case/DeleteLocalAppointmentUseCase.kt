...
class DeleteLocalAppointmentUseCase @Inject constructor(private val appointmentRepository: AppointmentRepository) {
    operator fun invoke(id:UUID): Flow<Response<Unit>> = flow {
        try{
            ...
            appointmentRepository.deleteAppointmentLocal(id)
